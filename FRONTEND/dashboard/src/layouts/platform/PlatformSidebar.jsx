      ...
      <nav className="sidebar-nav">
        <ul className="sidebar-menu">
          <li className="sidebar-nav-item">
            <NavLink to="/platform/dashboard" className={({ isActive }) => `sidebar-nav-link ${isActive ? 'active' : ''}`}>
              <span className="sidebar-nav-icon"><i className="fas fa-globe"></i></span>
              <span className="sidebar-nav-text">System Overview</span>
            </NavLink>
          </li>
        </ul>
      </nav>
